...
use App\Events\runoutWicketEvent;
...
use App\Events\reverseRunoutWicketEvent;
use App\Game;
...
class LiveScoreController extends Controller
{
    ...
    public function LiveUpdate(Request $request)
    {
        ...
        if ($request->value) {
            ...
            if ($request->value == 'W') {
                if ($request->wicket_type == 'runout') {
                    event(new runoutWicketEvent($match, $request));
                } else {
            ...
            elseif ($request->value == 'undo' || $request->value == 'reverse_inning') {
                ...
                elseif ($previous_ball->action == 'wicket') {
                    if ($previous_ball->wicket_type == 'runout')
                        event(new reverseRunoutWicketEvent($match, $request, $previous_ball));
                    else
                        event(new reverseWicketEvent($match, $request, $previous_ball));
                }
